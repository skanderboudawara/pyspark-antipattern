...
!!! warning "Experimental rule"
    This rule is **experimental**. Detection relies on static variable-name
    tracking across assignment statements and cannot follow aliasing through
    function calls, conditional branches, or dynamic attribute access.
