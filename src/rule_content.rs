...
static RULE_MARKDOWN: &[(&str, &str)] = &[
    ...
    ("ARR003", include_str!("../docs/rules/arr/ARR003.md")),
    ("ARR004", include_str!("../docs/rules/arr/ARR004.md")),
    ("ARR005", include_str!("../docs/rules/arr/ARR005.md")),
    ("ARR006", include_str!("../docs/rules/arr/ARR006.md")),
    ...
    ("F019", include_str!("../docs/rules/format/F019.md")),
    ("F020", include_str!("../docs/rules/format/F020.md")),
    ...
    ("S014", include_str!("../docs/rules/shuffle/S014.md")),
    ("S015", include_str!("../docs/rules/shuffle/S015.md")),
    ("S016", include_str!("../docs/rules/shuffle/S016.md")),
    ...
    ("PERF004", include_str!("../docs/rules/performance/PERF004.md")),
    ("PERF005", include_str!("../docs/rules/performance/PERF005.md")),
    ("PERF006", include_str!("../docs/rules/performance/PERF006.md")),
    ("PERF007", include_str!("../docs/rules/performance/PERF007.md")),
    ("PERF008", include_str!("../docs/rules/performance/PERF008.md")),
    ...
    ("U005", include_str!("../docs/rules/udf/U005.md")),
    ("U006", include_str!("../docs/rules/udf/U006.md")),
