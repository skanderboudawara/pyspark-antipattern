...
static RULE_MARKDOWN: &[(&str, &str)] = &[
    ...
    ("F013", include_str!("../rules/format/F013.md")),
    ("F014", include_str!("../rules/format/F014.md")),
    ("F015", include_str!("../rules/format/F015.md")),
    ("F016", include_str!("../rules/format/F016.md")),
    ("F017", include_str!("../rules/format/F017.md")),
    ...
    ("S013", include_str!("../rules/shuffle/S013.md")),
    ("PERF001", include_str!("../rules/performance/PERF001.md")),
    ("PERF002", include_str!("../rules/performance/PERF002.md")),
